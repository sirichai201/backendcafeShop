...
func User(app *fiber.App) {
	...
	v1.Post("/PostProduct", c.CreateProduct)
	v1.Get("/GetProductByID/:id", c.GetProductByID)
}
func Product(app *fiber.App) {
	...
	v5.Get("/Product", c.GetProducts)
	v5.Get("/GetProductByName", c.GetProductByName)
	v5.Post("/PostProduct", c.CreateProduct)
...
func Admin(app *fiber.App) {
	...
	//admin edit product
	v2.Get("/GetProduct", c.GetProducts)
